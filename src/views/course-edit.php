            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control" name="name" required value="<?= htmlspecialchars($course['name'] ?? ''); ?>">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="slug" required value="<?= htmlspecialchars($course['slug'] ?? ''); ?>" pattern="[a-z0-9\-]+" title="Apenas letras minúsculas, números e hífen">
                ...
                <div class="mb-3">
                    ...
                    <?php if ($course['picture']): ?>
                        <div class="mt-2">
                            <img src="<?= BASE_URL; ?>/uploads/<?= htmlspecialchars($course['picture']); ?>" class="img-thumbnail" style="max-height: 100px;" alt="Atual">
